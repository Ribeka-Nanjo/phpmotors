...
<body>
  ...
  <div id="wrapper">
    ...
    <fieldset>
        <legend> <h1><?php if(isset($invInfo['invMake'])){ 
	echo "Delete $invInfo[invMake] $invInfo[invModel]";} ?></h1></legend>
    ...
    <li>      
        ...
        <input type="submit" name="submit" id="invVehibtn" value="Delete Vehicle">
